...
import com.kulttuuri.inventoryscroll.proxy.IProxy;
...
public class QuickHotbarMod implements IPacketHandler
{
    ...
    @SidedProxy(clientSide = "com.kulttuuri.inventoryscroll.proxy.clientProxy", serverSide = "com.kulttuuri.inventoryscroll.proxy.serverProxy")
